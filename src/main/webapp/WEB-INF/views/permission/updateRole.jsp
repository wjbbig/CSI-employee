                    ...
                    <div class="layui-form" lay-filter="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="hidden" id="roleId" value="${requestScope.roleInf.id}">
                                <input type="text" name="roleName" class="layui-input" id="roleName" value="${requestScope.roleInf.roleName}">
                            </div>
                        </div>
                    </div>
